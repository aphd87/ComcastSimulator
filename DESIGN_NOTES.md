...
**Still open:**
- **No real human browser click-through has ever happened, on Day 1 or Day 2, on any feature built across any session** — the single most important gap. Reinforced 2026-07-27: two real production bugs (see item 11 above) were sitting in the TV/Streaming Decisions page's Simulate-button handler, undetected until a regression test finally exercised that exact click path.
