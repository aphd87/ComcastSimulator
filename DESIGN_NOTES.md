...
A Streamlit business simulation for teaching video network portfolio economics through the lens of Comcast/NBCUniversal's networks. Each network's level now runs its own real 5-year calendar era — Oxygen 2012-2016, Bravo 2017-2021, Peacock 2022-2026 (see `utils/game_state.py::LEVEL_START_YEAR`/`YEARS_PER_LEVEL`, reshaped 2026-07-27) — starting at the cord-cutting shift. FERPA-safe: students register with a pseudonym team name only, no PII is stored (see `app.py`, `utils/game_state.py`).
